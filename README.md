...
| `.config/kitty/kitty.conf` | `background_opacity 0.85` + live-tuning binds; 5000-line scrollback; `ctrl+shift+f` scrollback fzf; `alt+1..9` tab jumps; `sync_to_monitor no` for the post-resume freeze |
